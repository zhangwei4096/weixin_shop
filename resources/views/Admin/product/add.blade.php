    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="layui-upload">
                ...
                <div class="layui-upload-list" id="demo2" style="margin-left: 320px;"></div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                src = "{{ URL::asset('admin/lib/jquery/1.9.1/jquery.min.js') }}" ></script>
                ...
                <script type="text/javascript"
                        src="{{ URL::asset('admin/static/h-ui.admin/js/H-ui.admin.page.js') }}"></script>
                <!--/_footer /作为公共模版分离出去-->
                ...
                <script type="text/javascript"
                        src="{{ URL::asset('admin/lib/jquery.validation/1.14.0/messages_zh.js') }}"></script>
                <script type="text/javascript"
                        src="{{ URL::asset('admin/lib/webuploader/0.1.5/webuploader.min.js') }}"></script>
                <script type="text/javascript"
                        src="{{ URL::asset('admin/lib/ueditor/1.4.3/ueditor.config.js') }}"></script>
                <script type="text/javascript"
                        src="{{ URL::asset('admin/lib/ueditor/1.4.3/ueditor.all.min.js') }}"></script>
                <script type="text/javascript"
                        src="{{ URL::asset('admin/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js') }}"></script>
                ...
                <script type="text/javascript">
                    ...
                    function saveContent() {
                        ...
                        //console.log(my_array_name('images'));
                        if (title == null || title == "") {
                            layer.msg('标题不能为空');
                            return false;
                        }
