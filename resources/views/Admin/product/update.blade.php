...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="xs_price" id="" placeholder="" value="{{$data['xs_price']}}" class="input-text" style="width:90%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">市场价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="sc_price" id="" placeholder="" value="{{$data['sc_price']}}" class="input-text" style="width:90%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">成本价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="cb_price" id="" placeholder="" value="{{$data['cb_price']}}" class="input-text" style="width:90%">
                元</div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="start_time" value="{{$data['start_time']}}" id="datemin" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">销售结束时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="end_time" id="datemax" value="{{$data['end_time']}}" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="info" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)">{{$data['info']}}</textarea>
        ...
        <div class="row cl">
            ...
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="{{$data['thumb']}}" id="demo1" width="300" height="80" style="margin-left: 320px;">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <script type="text/javascript">
                    ...
                    function saveContent (){
                        ...
                        $.post('{{ url('admin/product/edit') }}',{id:id,_token:_token,title:title,chandi:chandi,jjdw:jjdw,
