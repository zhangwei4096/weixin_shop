...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('admin/static/h-ui.admin/skin/default/skin.css') }}"
          id="skin"/>
...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="chandi" value="{{$data['chandi']}}" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" name="jjdw">
                    <option selected value="{{$data['jjdw']}}">{{$data['jjdw']}}</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="zl" value="{{$data['zl']}}" class="input-text" style="width:90%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品出售价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="xs_price" id="" placeholder="" value="{{$data['xs_price']}}" class="input-text"
                       style="width:90%">
                元
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="sc_price" id="" placeholder="" value="{{$data['sc_price']}}" class="input-text"
                       style="width:90%">
                元
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="cb_price" id="" placeholder="" value="{{$data['cb_price']}}" class="input-text"
                       style="width:90%">
                元
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="start_time" value="{{$data['start_time']}}" id="datemin"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="end_time" id="datemax" value="{{$data['end_time']}}" class="input-text Wdate"
                       style="width:180px;">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="info" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符" datatype="*10-100"
                          dragonfly="true" nullmsg="备注不能为空！"
                          onKeyUp="textarealength(this,200)">{{$data['info']}}</textarea>
        ...
        <div class="row cl">
            ...
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="{{$data['thumb']}}" id="demo1" width="300" height="80"
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">轮播图片上传：</label>

            <div class="layui-upload">
                <button type="button" class="layui-btn" id="test2">轮播图片 上传</button>

                <div class="layui-upload-list" id="demo2" style="margin-left: 320px;">
                    @foreach($img as $v)
                    <p onclick='deletes(this);' style='display:inline-block;'>
                        <img class='layui-upload-img' width='100' height='100' src='{{ $v }}'>
    ...
    layui.use('upload', function () {
        ...
        upload.render({
            ...
            , done: function (res) {
                ...
                $('#demo2').append("<p onclick='deletes(this);'  style='display:inline-block;'><img  class='layui-upload-img' width='100' height='100' src='" + res.url + "'><input type='hidden' name='images[]' value='" + res.url + "'></p>");
