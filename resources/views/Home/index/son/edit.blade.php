    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  value="{{ $addrs->name }}" name="name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="phone" value="{{ $addrs->phone }}" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="addrs" readonly id="J_Address" placeholder="请选择收货地址" value="{{ $addrs->province }} {{ $addrs->city }} {{ $addrs->district }}" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="more"  value="{{ $addrs->more }}" class="input-text" style="width:90%">
            </div>
        </div>
        {{ csrf_field() }}
        <div class="row cl">
...
<script type="text/javascript">
    ...
    function saveContent() {
        ...
        $.post("{{ url('/edit/addr') }}",{_token:_token,id:id,name:name,phone:phone,addrs:addrs,more:more},function(result){
            if (result.msg == 'success'){
                //保存成功关闭当前页面
                layer.msg('地址修改成功',function(){//关闭弹出层
